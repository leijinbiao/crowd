...
public class CrowdExceptionResolver {
    ...
    public ModelAndView resolverAccessDeniedException(AccessDeniedException exception, HttpServletRequest request, HttpServletResponse response) throws IOException {
